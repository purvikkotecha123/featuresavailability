    ...
    <div class="container">
        <div class="search-container">
            <div style="margin-bottom: 10px;">
                <input type="text" id="searchInput" class="search-box" placeholder="Search lists or sublists...">
            </div>
    ...
    <script>
                ...
                list.sublists.forEach(subitem => {
                    if (subitem.toLowerCase().includes(searchTerm) && !foundItems.has(subitem)) {
                        ...
                        const parentLists = data.lists
                            ...
                            .map(l => l.name)
                            .join(', ');
                        results.push(`<div class="list-item" data-type="sublist">${subitem} (In: ${parentLists})</div>`);
                    }
                });
            });
        ...
        document.addEventListener('click', function(e) {
            ...
            if (item.dataset.type === 'list') {
                ...
                const parentLists = data.lists.filter(list => list.sublists.includes(selectedText));
                results = [
                    `<div class="list-item" style="font-weight: bold">"${selectedText}" available in:</div>`,
